...
impl BatchConfig {
    ...
    /// source. Measured on the local stack, lowering it from ten seconds to
    /// this took a streamed insert of 5000 rows from 11.2 s to 1.5 s,
    /// because the batch had been waiting out the window rather than
    /// working.
